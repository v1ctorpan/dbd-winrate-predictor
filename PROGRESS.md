...
**main（当前分支）**：Task1-4 + Task5 修复 + UT 提速(§3.15) + BV1QUt 验证驱动修复与并行产线(§3.16) + BV1pht 真值纠正(§3.19) + 自动锚点/切局(§3.21) + 结局自动标注(§3.22) 均已推送。dataset 现 6 行（BV1Uu=2、BV16=3、BV1pht=1、BV1QUt=0/0 已自动标注；BV1aat=-1）。
